...
public class Punto3 {
    ...
    public static void main(String[] args) {
        // Main code for data cypher of four digit number.
        ...
        CypherNumber cypNum = new CypherNumber(cypInt);
        JOptionPane.showMessageDialog(null,"Número Cifrado: " + cypNum.resultCypther());
    }
